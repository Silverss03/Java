...
public class FormThem extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sắp xếp", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 51))); // NOI18N

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setSelected(true);
        jRadioButton1.setText("Sắp xếp theo họ tên");
        ...
        jRadioButton2.setText("Sắp xếp theo số lượng mượn");
        ...
        jButton3.setText("Tính số sách mượn của từng bạn đọc");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Map<String, Integer> mp = lQLMuon.stream().collect(Collectors.groupingBy(
                QLMuon:: getMaVaTen, Collectors.summingInt(QLMuon :: getSluong))) ;
        jTextArea1.setText("Bạn đọc \t\t Số lượng sách mượn");
        mp.forEach((K,V) -> {
            jTextArea1.append("\n" + K + "\t" + V);
        });
